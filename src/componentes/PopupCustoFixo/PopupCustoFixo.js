...
import "./PopupCustoFixo.css";
import React, {Component} from "react";
import Axios from "../../Axios";
import { Authcontext } from "../Store/Context";


export default class PopupCustoFixo extends Component{
    constructor(props){
        super(props)
        this.state = {
    ...
    render(){
        const {pp_custo, setpp_custo} = this.context
        return(
            <div className={pp_custo}>
                <div className="menu">
